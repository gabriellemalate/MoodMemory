            ...
            <section className='add-mood-quick'>
              ...
              <article className='add-mood-quick__level'>
                ...
                <div className='add-mood-quick__level-state'>
                  <button className='add-mood-quick__level-state-option add-mood-quick__level-state-option--dep'>Depressed</button>
                  <button className='add-mood-quick__level-state-option add-mood-quick__level-state-option--wnl'>WNL</button>
                  <button className='add-mood-quick__level-state-option add-mood-quick__level-state-option--elev'>Elevated</button>
                </div>
              ...
              <article className='add-mood-quick__sleep'>
                <form className='add-mood-quick__sleep-form'>
                  <label htmlFor="hours slept" className='add-mood-quick__sleep-form-head'>Hours Slept</label>
                  <select className='add-mood-quick__sleep-form-menu'>
                    <optgroup className='add-mood-quick__sleep-form-menugroup' label="number of hours">
                      ...
                      <option className='add-mood-quick__sleep-form-menugroup-option add-mood-quick__sleep-form-menugroup-option--over'>
                        9-11 hours
                      </option>
