...
function LoadingPage() {
    return (
        <main className="loadingpage">
            ...
            <p className="loadingpage__redirect"> Taking too long?
                <ul className="loadingpage__redirect-eq">Return to~ 
                    <li><Link className="loadingpage__redirect-mood" to="/logs">Mood Logs</Link> or </li>
